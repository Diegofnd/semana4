...
/*return repository.deleteById(id)
                .switchIfEmpty(Mono.error(new IllegalArgumentException("El registro no esta en la base de datos para eliminar")))
                 .flatMap(task->repository.findById(task,id));
                 */
         ...
         return repository.findById(id)
                .switchIfEmpty(Mono.error(new IllegalArgumentException("El registro no esta en la base de datos para eliminar")))
                .flatMap(task -> repository.delete(task));
